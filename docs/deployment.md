...
>
> **중요**: 이 명령어는 **배포 시에만** 주의해서 사용하세요. 개발 환경에서는 사용이 금지되어 있습니다 (CLAUDE.md의 "절대 금지 작업" 참조).
...
> **참고**: 전체 환경 변수의 상세 설명과 로컬 개발 설정은 [설치 가이드](./installation.md#3단계-환경-변수-설정)를 참고하세요. 아래는 배포 시 필요한 환경 변수 목록입니다.
