    ...
    public: {
        Tables: {
            ...
            product_payment_type_price: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'public_prouduct_payment_type_price_product_payment_type_id_fkey';
                        columns: ['product_payment_type_id'];
                        isOneToOne: false;
                        referencedRelation: 'product_payment_type';
                        referencedColumns: ['id'];
                    },
                ];
            };
            subscriptions: {
                Row: {
                    active_status: Database['public']['Enums']['subscription_active_status'] | null;
                    ...
                    pg: Database['public']['Enums']['pg'];
                    product_payment_type_price_id: number;
                    updated_at: string;
                    user_id: string;
                };
                Insert: {
                    active_status?:
                        | Database['public']['Enums']['subscription_active_status']
                        | null;
                    billing_date?: string | null;
                    billing_key?: string | null;
                    created_at?: string;
                ...
                Relationships: [
                    {
                        foreignKeyName: 'public_subscriptions_product_payment_type_price_id_fkey';
                        columns: ['product_payment_type_price_id'];
                        isOneToOne: false;
                        referencedRelation: 'product_payment_type_price';
                        referencedColumns: ['id'];
                    },
                ];
            };
            ...
            usage: {
                Row: {
                    ...
                    is_subscription_paused: boolean | null;
                    last_reset_date: string;
                    last_transaction_id: string | null;
                    management_url: string | null;
                    next_reset_date: string;
                    plan_type: Database['public']['Enums']['subscription_plan'];
                    premium_expires_date: string | null;
                    premium_grace_period_expires_date: string | null;
                    premium_product_identifier: string | null;
                    premium_product_plan_identifier: string | null;
        ...
        Enums: {
            ...
            order_status: 'SUCCESS' | 'ON-HOLD' | 'PENDING' | 'FAILED' | 'CANCEL' | 'REFUND';
            page_type: 'text' | 'draw';
            payment_cycle: 'none' | 'day' | 'week' | 'month' | 'year';
            pg: 'PAYPAL' | 'APPLE' | 'GOOGLE' | 'TOSS' | 'NAVER';
            store_type: 'app_store' | 'play_store' | 'stripe';
            ...
            subscription_plan: 'FREE' | 'MONTHLY' | 'YEARLY' | 'WEEKLY';
            subscription_status:
                | 'ACTIVE'
